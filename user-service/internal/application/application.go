...
import (
	...
	"github.com/BernardN38/social-stream-backend/user-service/internal/messaging"
	"github.com/BernardN38/social-stream-backend/user-service/internal/router"
...
func NewApp() *App {
	...
	//listen for messages
	mr, err := messaging.New(conn, *service)
	if err != nil {
		log.Fatalln(err)
	}
